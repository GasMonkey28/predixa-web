...
function useAccessControl() {
  ...
  useEffect(() => {
    ...
    const storedAccess = sessionStorage.getItem('history-40-access')
  ...
  const handleCodeSubmit = (e: React.FormEvent) => {
    ...
    const correctCode = process.env.NEXT_PUBLIC_HISTORY_40_CODE || 'predixa40'
    
    if (code === correctCode) {
      sessionStorage.setItem('history-40-access', 'granted')
      setHasAccess(true)
      setError(null)
    } else {
...
export default function History40Page() {
