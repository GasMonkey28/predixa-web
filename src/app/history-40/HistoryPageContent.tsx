...
export default function HistoryPageContent() {
  ...
  useEffect(() => {
    async function fetchData() {
      try {
        const response = await fetch(`/api/history-40?t=${Date.now()}`)
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-blue-900 to-gray-900">
      ...
      <div className="relative mx-auto max-w-7xl p-6">
        ...
        >
          ...
          <p className="text-gray-300 text-lg">Last 40 Trading Days - SPY OHLC & Tier Rankings</p>
        </motion.div>
        ...
        >
          <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-zinc-900 to-zinc-950 border border-zinc-800 p-6">
            <div className="mb-4">
              ...
              <p className="text-zinc-400 text-sm mt-1">Last 40 Trading Days</p>
            </div>
