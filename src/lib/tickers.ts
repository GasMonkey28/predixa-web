...
export const EQUITY_TICKERS = ['AAPL', 'AMZN', 'AMD', 'AVGO', 'BA', 'BABA', 'BAC', 'BITO', 'COIN', 'EFA', 'F', 'FXI', 'GLD', 'GOOG', 'HOOD', 'HYG', 'IBIT', 'INTC', 'IWM', 'JD', 'JPM', 'MARA', 'META', 'MRNA', 'MSFT', 'MSTR', 'MU', 'NFLX', 'NVDA', 'ORCL', 'PLTR'] as const
