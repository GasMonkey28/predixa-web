# Predixa-XOM-ML-Then-Tiers

Per-ticker equity pipeline (XOM pilot). Tiers write ratings + detail description
into `db/tickers/XOM/features.db`.
...
| State | Function |
|-------|----------|
| Features | `predixa-features-XOM` |
| ML1 | `predixa-ml1-XOM` |
| ML2 | `predixa-ml2-XOM` |
| ML3 | `predixa-ml3-XOM` |
| Tiers | `predixa-tiers-XOM` |

Handlers: `tradespark/ticker-handlers/XOM/ml/model_3mix/{features,model1,model2,model3,tiers}/`.
...
aws stepfunctions create-state-machine \
  --name Predixa-XOM-ML-Then-Tiers \
  --definition file://infrastructure/step-functions/xom-ml-then-tiers.asl.json \
