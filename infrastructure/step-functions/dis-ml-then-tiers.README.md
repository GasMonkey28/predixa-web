# Predixa-DIS-ML-Then-Tiers

Per-ticker equity pipeline (DIS pilot). Tiers write ratings + detail description
into `db/tickers/DIS/features.db`.
...
| State | Function |
|-------|----------|
| Features | `predixa-features-DIS` |
| ML1 | `predixa-ml1-DIS` |
| ML2 | `predixa-ml2-DIS` |
| ML3 | `predixa-ml3-DIS` |
| Tiers | `predixa-tiers-DIS` |

Handlers: `tradespark/ticker-handlers/DIS/ml/model_3mix/{features,model1,model2,model3,tiers}/`.
...
aws stepfunctions create-state-machine \
  --name Predixa-DIS-ML-Then-Tiers \
  --definition file://infrastructure/step-functions/dis-ml-then-tiers.asl.json \
