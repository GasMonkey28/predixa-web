# Predixa-NFLX-ML-Then-Tiers

Per-ticker equity pipeline (NFLX pilot). Tiers write ratings + detail description
into `db/tickers/NFLX/features.db`.
...
| State | Function |
|-------|----------|
| Features | `predixa-features-NFLX` |
| ML1 | `predixa-ml1-NFLX` |
| ML2 | `predixa-ml2-NFLX` |
| ML3 | `predixa-ml3-NFLX` |
| Tiers | `predixa-tiers-NFLX` |

Handlers: `tradespark/ticker-handlers/NFLX/ml/model_3mix/{features,model1,model2,model3,tiers}/`.
...
aws stepfunctions create-state-machine \
  --name Predixa-NFLX-ML-Then-Tiers \
  --definition file://infrastructure/step-functions/nflx-ml-then-tiers.asl.json \
