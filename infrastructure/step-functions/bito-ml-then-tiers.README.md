# Predixa-BITO-ML-Then-Tiers

Per-ticker equity pipeline (BITO pilot). Tiers write ratings + detail description
into `db/tickers/BITO/features.db`.
...
| State | Function |
|-------|----------|
| Features | `predixa-features-BITO` |
| ML1 | `predixa-ml1-BITO` |
| ML2 | `predixa-ml2-BITO` |
| ML3 | `predixa-ml3-BITO` |
| Tiers | `predixa-tiers-BITO` |

Handlers: `tradespark/ticker-handlers/BITO/ml/model_3mix/{features,model1,model2,model3,tiers}/`.
...
aws stepfunctions create-state-machine \
  --name Predixa-BITO-ML-Then-Tiers \
  --definition file://infrastructure/step-functions/bito-ml-then-tiers.asl.json \
