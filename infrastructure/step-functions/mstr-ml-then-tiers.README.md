# Predixa-MSTR-ML-Then-Tiers

Per-ticker equity pipeline (MSTR pilot). Tiers write ratings + detail description
into `db/tickers/MSTR/features.db`.
...
| State | Function |
|-------|----------|
| Features | `predixa-features-MSTR` |
| ML1 | `predixa-ml1-MSTR` |
| ML2 | `predixa-ml2-MSTR` |
| ML3 | `predixa-ml3-MSTR` |
| Tiers | `predixa-tiers-MSTR` |

Handlers: `tradespark/ticker-handlers/MSTR/ml/model_3mix/{features,model1,model2,model3,tiers}/`.
...
aws stepfunctions create-state-machine \
  --name Predixa-MSTR-ML-Then-Tiers \
  --definition file://infrastructure/step-functions/mstr-ml-then-tiers.asl.json \
