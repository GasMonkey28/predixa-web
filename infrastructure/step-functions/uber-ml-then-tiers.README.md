# Predixa-UBER-ML-Then-Tiers

Per-ticker equity pipeline (UBER pilot). Tiers write ratings + detail description
into `db/tickers/UBER/features.db`.
...
| State | Function |
|-------|----------|
| Features | `predixa-features-UBER` |
| ML1 | `predixa-ml1-UBER` |
| ML2 | `predixa-ml2-UBER` |
| ML3 | `predixa-ml3-UBER` |
| Tiers | `predixa-tiers-UBER` |

Handlers: `tradespark/ticker-handlers/UBER/ml/model_3mix/{features,model1,model2,model3,tiers}/`.
...
aws stepfunctions create-state-machine \
  --name Predixa-UBER-ML-Then-Tiers \
  --definition file://infrastructure/step-functions/uber-ml-then-tiers.asl.json \
