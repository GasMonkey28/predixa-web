# Predixa-SOXS-ML-Then-Tiers

Per-ticker equity pipeline (SOXS pilot). Tiers write ratings + detail description
into `db/tickers/SOXS/features.db`.
...
| State | Function |
|-------|----------|
| Features | `predixa-features-SOXS` |
| ML1 | `predixa-ml1-SOXS` |
| ML2 | `predixa-ml2-SOXS` |
| ML3 | `predixa-ml3-SOXS` |
| Tiers | `predixa-tiers-SOXS` |

Handlers: `tradespark/ticker-handlers/SOXS/ml/model_3mix/{features,model1,model2,model3,tiers}/`.
...
aws stepfunctions create-state-machine \
  --name Predixa-SOXS-ML-Then-Tiers \
  --definition file://infrastructure/step-functions/soxs-ml-then-tiers.asl.json \
