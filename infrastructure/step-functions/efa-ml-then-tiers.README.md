# Predixa-EFA-ML-Then-Tiers

Per-ticker equity pipeline (EFA pilot). Tiers write ratings + detail description
into `db/tickers/EFA/features.db`.
...
| State | Function |
|-------|----------|
| Features | `predixa-features-EFA` |
| ML1 | `predixa-ml1-EFA` |
| ML2 | `predixa-ml2-EFA` |
| ML3 | `predixa-ml3-EFA` |
| Tiers | `predixa-tiers-EFA` |

Handlers: `tradespark/ticker-handlers/EFA/ml/model_3mix/{features,model1,model2,model3,tiers}/`.
...
aws stepfunctions create-state-machine \
  --name Predixa-EFA-ML-Then-Tiers \
  --definition file://infrastructure/step-functions/efa-ml-then-tiers.asl.json \
