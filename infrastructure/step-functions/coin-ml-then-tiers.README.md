# Predixa-COIN-ML-Then-Tiers

Per-ticker equity pipeline (COIN pilot). Tiers write ratings + detail description
into `db/tickers/COIN/features.db`.
...
| State | Function |
|-------|----------|
| Features | `predixa-features-COIN` |
| ML1 | `predixa-ml1-COIN` |
| ML2 | `predixa-ml2-COIN` |
| ML3 | `predixa-ml3-COIN` |
| Tiers | `predixa-tiers-COIN` |

Handlers: `tradespark/ticker-handlers/COIN/ml/model_3mix/{features,model1,model2,model3,tiers}/`.
...
aws stepfunctions create-state-machine \
  --name Predixa-COIN-ML-Then-Tiers \
  --definition file://infrastructure/step-functions/coin-ml-then-tiers.asl.json \
