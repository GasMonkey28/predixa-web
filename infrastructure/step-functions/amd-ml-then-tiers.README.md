# Predixa-AMD-ML-Then-Tiers

Per-ticker equity pipeline (AMD pilot). Tiers write ratings + detail description
into `db/tickers/AMD/features.db`.
...
| State | Function |
|-------|----------|
| Features | `predixa-features-AMD` |
| ML1 | `predixa-ml1-AMD` |
| ML2 | `predixa-ml2-AMD` |
| ML3 | `predixa-ml3-AMD` |
| Tiers | `predixa-tiers-AMD` |

Handlers: `tradespark/ticker-handlers/AMD/ml/model_3mix/{features,model1,model2,model3,tiers}/`.
...
aws stepfunctions create-state-machine \
  --name Predixa-AMD-ML-Then-Tiers \
  --definition file://infrastructure/step-functions/amd-ml-then-tiers.asl.json \
