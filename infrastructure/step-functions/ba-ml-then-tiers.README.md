# Predixa-BA-ML-Then-Tiers

Per-ticker equity pipeline (BA pilot). Tiers write ratings + detail description
into `db/tickers/BA/features.db`.
...
| State | Function |
|-------|----------|
| Features | `predixa-features-BA` |
| ML1 | `predixa-ml1-BA` |
| ML2 | `predixa-ml2-BA` |
| ML3 | `predixa-ml3-BA` |
| Tiers | `predixa-tiers-BA` |

Handlers: `tradespark/ticker-handlers/BA/ml/model_3mix/{features,model1,model2,model3,tiers}/`.
...
aws stepfunctions create-state-machine \
  --name Predixa-BA-ML-Then-Tiers \
  --definition file://infrastructure/step-functions/ba-ml-then-tiers.asl.json \
