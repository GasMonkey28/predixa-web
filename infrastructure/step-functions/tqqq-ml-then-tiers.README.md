# Predixa-TQQQ-ML-Then-Tiers

Per-ticker equity pipeline (TQQQ pilot). Tiers write ratings + detail description
into `db/tickers/TQQQ/features.db`.
...
| State | Function |
|-------|----------|
| Features | `predixa-features-TQQQ` |
| ML1 | `predixa-ml1-TQQQ` |
| ML2 | `predixa-ml2-TQQQ` |
| ML3 | `predixa-ml3-TQQQ` |
| Tiers | `predixa-tiers-TQQQ` |

Handlers: `tradespark/ticker-handlers/TQQQ/ml/model_3mix/{features,model1,model2,model3,tiers}/`.
...
aws stepfunctions create-state-machine \
  --name Predixa-TQQQ-ML-Then-Tiers \
  --definition file://infrastructure/step-functions/tqqq-ml-then-tiers.asl.json \
