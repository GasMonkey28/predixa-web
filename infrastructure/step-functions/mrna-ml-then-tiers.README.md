# Predixa-MRNA-ML-Then-Tiers

Per-ticker equity pipeline (MRNA pilot). Tiers write ratings + detail description
into `db/tickers/MRNA/features.db`.
...
| State | Function |
|-------|----------|
| Features | `predixa-features-MRNA` |
| ML1 | `predixa-ml1-MRNA` |
| ML2 | `predixa-ml2-MRNA` |
| ML3 | `predixa-ml3-MRNA` |
| Tiers | `predixa-tiers-MRNA` |

Handlers: `tradespark/ticker-handlers/MRNA/ml/model_3mix/{features,model1,model2,model3,tiers}/`.
...
aws stepfunctions create-state-machine \
  --name Predixa-MRNA-ML-Then-Tiers \
  --definition file://infrastructure/step-functions/mrna-ml-then-tiers.asl.json \
