# Predixa-IBIT-ML-Then-Tiers

Per-ticker equity pipeline (IBIT pilot). Tiers write ratings + detail description
into `db/tickers/IBIT/features.db`.
...
| State | Function |
|-------|----------|
| Features | `predixa-features-IBIT` |
| ML1 | `predixa-ml1-IBIT` |
| ML2 | `predixa-ml2-IBIT` |
| ML3 | `predixa-ml3-IBIT` |
| Tiers | `predixa-tiers-IBIT` |

Handlers: `tradespark/ticker-handlers/IBIT/ml/model_3mix/{features,model1,model2,model3,tiers}/`.
...
aws stepfunctions create-state-machine \
  --name Predixa-IBIT-ML-Then-Tiers \
  --definition file://infrastructure/step-functions/ibit-ml-then-tiers.asl.json \
