# Predixa-SOFI-ML-Then-Tiers

Per-ticker equity pipeline (SOFI pilot). Tiers write ratings + detail description
into `db/tickers/SOFI/features.db`.
...
| State | Function |
|-------|----------|
| Features | `predixa-features-SOFI` |
| ML1 | `predixa-ml1-SOFI` |
| ML2 | `predixa-ml2-SOFI` |
| ML3 | `predixa-ml3-SOFI` |
| Tiers | `predixa-tiers-SOFI` |

Handlers: `tradespark/ticker-handlers/SOFI/ml/model_3mix/{features,model1,model2,model3,tiers}/`.
...
aws stepfunctions create-state-machine \
  --name Predixa-SOFI-ML-Then-Tiers \
  --definition file://infrastructure/step-functions/sofi-ml-then-tiers.asl.json \
