# Predixa-IWM-ML-Then-Tiers

Per-ticker equity pipeline (IWM pilot). Tiers write ratings + detail description
into `db/tickers/IWM/features.db`.
...
| State | Function |
|-------|----------|
| Features | `predixa-features-IWM` |
| ML1 | `predixa-ml1-IWM` |
| ML2 | `predixa-ml2-IWM` |
| ML3 | `predixa-ml3-IWM` |
| Tiers | `predixa-tiers-IWM` |

Handlers: `tradespark/ticker-handlers/IWM/ml/model_3mix/{features,model1,model2,model3,tiers}/`.
...
aws stepfunctions create-state-machine \
  --name Predixa-IWM-ML-Then-Tiers \
  --definition file://infrastructure/step-functions/iwm-ml-then-tiers.asl.json \
