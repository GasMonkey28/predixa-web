# Predixa-AAPL-ML-Then-Tiers

Per-ticker equity pipeline (AAPL pilot). Tiers write ratings + detail description
into `db/tickers/AAPL/features.db`.
...
| State | Function |
|-------|----------|
| Features | `predixa-features-AAPL` |
| ML1 | `predixa-ml1-AAPL` |
| ML2 | `predixa-ml2-AAPL` |
| ML3 | `predixa-ml3-AAPL` |
| Tiers | `predixa-tiers-AAPL` |

Handlers: `tradespark/ticker-handlers/AAPL/ml/model_3mix/{features,model1,model2,model3,tiers}/`.
...
aws stepfunctions create-state-machine \
  --name Predixa-AAPL-ML-Then-Tiers \
  --definition file://infrastructure/step-functions/aapl-ml-then-tiers.asl.json \
