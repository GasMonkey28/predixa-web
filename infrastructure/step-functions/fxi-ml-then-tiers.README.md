# Predixa-FXI-ML-Then-Tiers

Per-ticker equity pipeline (FXI pilot). Tiers write ratings + detail description
into `db/tickers/FXI/features.db`.
...
| State | Function |
|-------|----------|
| Features | `predixa-features-FXI` |
| ML1 | `predixa-ml1-FXI` |
| ML2 | `predixa-ml2-FXI` |
| ML3 | `predixa-ml3-FXI` |
| Tiers | `predixa-tiers-FXI` |

Handlers: `tradespark/ticker-handlers/FXI/ml/model_3mix/{features,model1,model2,model3,tiers}/`.
...
aws stepfunctions create-state-machine \
  --name Predixa-FXI-ML-Then-Tiers \
  --definition file://infrastructure/step-functions/fxi-ml-then-tiers.asl.json \
