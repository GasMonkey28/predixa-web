# Predixa-JD-ML-Then-Tiers

Per-ticker equity pipeline (JD pilot). Tiers write ratings + detail description
into `db/tickers/JD/features.db`.
...
| State | Function |
|-------|----------|
| Features | `predixa-features-JD` |
| ML1 | `predixa-ml1-JD` |
| ML2 | `predixa-ml2-JD` |
| ML3 | `predixa-ml3-JD` |
| Tiers | `predixa-tiers-JD` |

Handlers: `tradespark/ticker-handlers/JD/ml/model_3mix/{features,model1,model2,model3,tiers}/`.
...
aws stepfunctions create-state-machine \
  --name Predixa-JD-ML-Then-Tiers \
  --definition file://infrastructure/step-functions/jd-ml-then-tiers.asl.json \
