# Predixa-SHOP-ML-Then-Tiers

Per-ticker equity pipeline (SHOP pilot). Tiers write ratings + detail description
into `db/tickers/SHOP/features.db`.
...
| State | Function |
|-------|----------|
| Features | `predixa-features-SHOP` |
| ML1 | `predixa-ml1-SHOP` |
| ML2 | `predixa-ml2-SHOP` |
| ML3 | `predixa-ml3-SHOP` |
| Tiers | `predixa-tiers-SHOP` |

Handlers: `tradespark/ticker-handlers/SHOP/ml/model_3mix/{features,model1,model2,model3,tiers}/`.
...
aws stepfunctions create-state-machine \
  --name Predixa-SHOP-ML-Then-Tiers \
  --definition file://infrastructure/step-functions/shop-ml-then-tiers.asl.json \
