# Predixa-AVGO-ML-Then-Tiers

Per-ticker equity pipeline (AVGO pilot). Tiers write ratings + detail description
into `db/tickers/AVGO/features.db`.
...
| State | Function |
|-------|----------|
| Features | `predixa-features-AVGO` |
| ML1 | `predixa-ml1-AVGO` |
| ML2 | `predixa-ml2-AVGO` |
| ML3 | `predixa-ml3-AVGO` |
| Tiers | `predixa-tiers-AVGO` |

Handlers: `tradespark/ticker-handlers/AVGO/ml/model_3mix/{features,model1,model2,model3,tiers}/`.
...
aws stepfunctions create-state-machine \
  --name Predixa-AVGO-ML-Then-Tiers \
  --definition file://infrastructure/step-functions/avgo-ml-then-tiers.asl.json \
