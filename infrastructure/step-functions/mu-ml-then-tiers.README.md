# Predixa-MU-ML-Then-Tiers

Per-ticker equity pipeline (MU pilot). Tiers write ratings + detail description
into `db/tickers/MU/features.db`.
...
| State | Function |
|-------|----------|
| Features | `predixa-features-MU` |
| ML1 | `predixa-ml1-MU` |
| ML2 | `predixa-ml2-MU` |
| ML3 | `predixa-ml3-MU` |
| Tiers | `predixa-tiers-MU` |

Handlers: `tradespark/ticker-handlers/MU/ml/model_3mix/{features,model1,model2,model3,tiers}/`.
...
aws stepfunctions create-state-machine \
  --name Predixa-MU-ML-Then-Tiers \
  --definition file://infrastructure/step-functions/mu-ml-then-tiers.asl.json \
