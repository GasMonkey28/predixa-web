# Predixa-F-ML-Then-Tiers

Per-ticker equity pipeline (F pilot). Tiers write ratings + detail description
into `db/tickers/F/features.db`.
...
| State | Function |
|-------|----------|
| Features | `predixa-features-F` |
| ML1 | `predixa-ml1-F` |
| ML2 | `predixa-ml2-F` |
| ML3 | `predixa-ml3-F` |
| Tiers | `predixa-tiers-F` |

Handlers: `tradespark/ticker-handlers/F/ml/model_3mix/{features,model1,model2,model3,tiers}/`.
...
aws stepfunctions create-state-machine \
  --name Predixa-F-ML-Then-Tiers \
  --definition file://infrastructure/step-functions/f-ml-then-tiers.asl.json \
