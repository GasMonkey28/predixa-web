# Predixa-SOXL-ML-Then-Tiers

Per-ticker equity pipeline (SOXL pilot). Tiers write ratings + detail description
into `db/tickers/SOXL/features.db`.
...
| State | Function |
|-------|----------|
| Features | `predixa-features-SOXL` |
| ML1 | `predixa-ml1-SOXL` |
| ML2 | `predixa-ml2-SOXL` |
| ML3 | `predixa-ml3-SOXL` |
| Tiers | `predixa-tiers-SOXL` |

Handlers: `tradespark/ticker-handlers/SOXL/ml/model_3mix/{features,model1,model2,model3,tiers}/`.
...
aws stepfunctions create-state-machine \
  --name Predixa-SOXL-ML-Then-Tiers \
  --definition file://infrastructure/step-functions/soxl-ml-then-tiers.asl.json \
