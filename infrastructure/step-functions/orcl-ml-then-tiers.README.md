# Predixa-ORCL-ML-Then-Tiers

Per-ticker equity pipeline (ORCL pilot). Tiers write ratings + detail description
into `db/tickers/ORCL/features.db`.
...
| State | Function |
|-------|----------|
| Features | `predixa-features-ORCL` |
| ML1 | `predixa-ml1-ORCL` |
| ML2 | `predixa-ml2-ORCL` |
| ML3 | `predixa-ml3-ORCL` |
| Tiers | `predixa-tiers-ORCL` |

Handlers: `tradespark/ticker-handlers/ORCL/ml/model_3mix/{features,model1,model2,model3,tiers}/`.
...
aws stepfunctions create-state-machine \
  --name Predixa-ORCL-ML-Then-Tiers \
  --definition file://infrastructure/step-functions/orcl-ml-then-tiers.asl.json \
