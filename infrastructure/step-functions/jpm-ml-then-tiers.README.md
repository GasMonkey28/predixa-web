# Predixa-JPM-ML-Then-Tiers

Per-ticker equity pipeline (JPM pilot). Tiers write ratings + detail description
into `db/tickers/JPM/features.db`.
...
| State | Function |
|-------|----------|
| Features | `predixa-features-JPM` |
| ML1 | `predixa-ml1-JPM` |
| ML2 | `predixa-ml2-JPM` |
| ML3 | `predixa-ml3-JPM` |
| Tiers | `predixa-tiers-JPM` |

Handlers: `tradespark/ticker-handlers/JPM/ml/model_3mix/{features,model1,model2,model3,tiers}/`.
...
aws stepfunctions create-state-machine \
  --name Predixa-JPM-ML-Then-Tiers \
  --definition file://infrastructure/step-functions/jpm-ml-then-tiers.asl.json \
