# Predixa-NVDA-ML-Then-Tiers

Per-ticker equity pipeline (NVDA pilot). Tiers write ratings + detail description
into `db/tickers/NVDA/features.db`.
...
| State | Function |
|-------|----------|
| Features | `predixa-features-NVDA` |
| ML1 | `predixa-ml1-NVDA` |
| ML2 | `predixa-ml2-NVDA` |
| ML3 | `predixa-ml3-NVDA` |
| Tiers | `predixa-tiers-NVDA` |

Handlers: `tradespark/ticker-handlers/NVDA/ml/model_3mix/{features,model1,model2,model3,tiers}/`.
...
aws stepfunctions create-state-machine \
  --name Predixa-NVDA-ML-Then-Tiers \
  --definition file://infrastructure/step-functions/nvda-ml-then-tiers.asl.json \
