# Predixa-HOOD-ML-Then-Tiers

Per-ticker equity pipeline (HOOD pilot). Tiers write ratings + detail description
into `db/tickers/HOOD/features.db`.
...
| State | Function |
|-------|----------|
| Features | `predixa-features-HOOD` |
| ML1 | `predixa-ml1-HOOD` |
| ML2 | `predixa-ml2-HOOD` |
| ML3 | `predixa-ml3-HOOD` |
| Tiers | `predixa-tiers-HOOD` |

Handlers: `tradespark/ticker-handlers/HOOD/ml/model_3mix/{features,model1,model2,model3,tiers}/`.
...
aws stepfunctions create-state-machine \
  --name Predixa-HOOD-ML-Then-Tiers \
  --definition file://infrastructure/step-functions/hood-ml-then-tiers.asl.json \
