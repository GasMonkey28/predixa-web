# Predixa-QQQ-ML-Then-Tiers

Per-ticker equity pipeline (QQQ pilot). Tiers write ratings + detail description
into `db/tickers/QQQ/features.db`.
...
| State | Function |
|-------|----------|
| Features | `predixa-features-QQQ` |
| ML1 | `predixa-ml1-QQQ` |
| ML2 | `predixa-ml2-QQQ` |
| ML3 | `predixa-ml3-QQQ` |
| Tiers | `predixa-tiers-QQQ` |

Handlers: `tradespark/ticker-handlers/QQQ/ml/model_3mix/{features,model1,model2,model3,tiers}/`.
...
aws stepfunctions create-state-machine \
  --name Predixa-QQQ-ML-Then-Tiers \
  --definition file://infrastructure/step-functions/qqq-ml-then-tiers.asl.json \
