# Predixa-GOOG-ML-Then-Tiers

Per-ticker equity pipeline (GOOG pilot). Tiers write ratings + detail description
into `db/tickers/GOOG/features.db`.
...
| State | Function |
|-------|----------|
| Features | `predixa-features-GOOG` |
| ML1 | `predixa-ml1-GOOG` |
| ML2 | `predixa-ml2-GOOG` |
| ML3 | `predixa-ml3-GOOG` |
| Tiers | `predixa-tiers-GOOG` |

Handlers: `tradespark/ticker-handlers/GOOG/ml/model_3mix/{features,model1,model2,model3,tiers}/`.
...
aws stepfunctions create-state-machine \
  --name Predixa-GOOG-ML-Then-Tiers \
  --definition file://infrastructure/step-functions/goog-ml-then-tiers.asl.json \
