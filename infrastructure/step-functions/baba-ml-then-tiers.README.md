# Predixa-BABA-ML-Then-Tiers

Per-ticker equity pipeline (BABA pilot). Tiers write ratings + detail description
into `db/tickers/BABA/features.db`.
...
| State | Function |
|-------|----------|
| Features | `predixa-features-BABA` |
| ML1 | `predixa-ml1-BABA` |
| ML2 | `predixa-ml2-BABA` |
| ML3 | `predixa-ml3-BABA` |
| Tiers | `predixa-tiers-BABA` |

Handlers: `tradespark/ticker-handlers/BABA/ml/model_3mix/{features,model1,model2,model3,tiers}/`.
...
aws stepfunctions create-state-machine \
  --name Predixa-BABA-ML-Then-Tiers \
  --definition file://infrastructure/step-functions/baba-ml-then-tiers.asl.json \
