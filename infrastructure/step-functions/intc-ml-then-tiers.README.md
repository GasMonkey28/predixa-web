# Predixa-INTC-ML-Then-Tiers

Per-ticker equity pipeline (INTC pilot). Tiers write ratings + detail description
into `db/tickers/INTC/features.db`.
...
| State | Function |
|-------|----------|
| Features | `predixa-features-INTC` |
| ML1 | `predixa-ml1-INTC` |
| ML2 | `predixa-ml2-INTC` |
| ML3 | `predixa-ml3-INTC` |
| Tiers | `predixa-tiers-INTC` |

Handlers: `tradespark/ticker-handlers/INTC/ml/model_3mix/{features,model1,model2,model3,tiers}/`.
...
aws stepfunctions create-state-machine \
  --name Predixa-INTC-ML-Then-Tiers \
  --definition file://infrastructure/step-functions/intc-ml-then-tiers.asl.json \
