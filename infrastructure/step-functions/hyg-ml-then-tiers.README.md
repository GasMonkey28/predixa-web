# Predixa-HYG-ML-Then-Tiers

Per-ticker equity pipeline (HYG pilot). Tiers write ratings + detail description
into `db/tickers/HYG/features.db`.
...
| State | Function |
|-------|----------|
| Features | `predixa-features-HYG` |
| ML1 | `predixa-ml1-HYG` |
| ML2 | `predixa-ml2-HYG` |
| ML3 | `predixa-ml3-HYG` |
| Tiers | `predixa-tiers-HYG` |

Handlers: `tradespark/ticker-handlers/HYG/ml/model_3mix/{features,model1,model2,model3,tiers}/`.
...
aws stepfunctions create-state-machine \
  --name Predixa-HYG-ML-Then-Tiers \
  --definition file://infrastructure/step-functions/hyg-ml-then-tiers.asl.json \
