# Predixa-GLD-ML-Then-Tiers

Per-ticker equity pipeline (GLD pilot). Tiers write ratings + detail description
into `db/tickers/GLD/features.db`.
...
| State | Function |
|-------|----------|
| Features | `predixa-features-GLD` |
| ML1 | `predixa-ml1-GLD` |
| ML2 | `predixa-ml2-GLD` |
| ML3 | `predixa-ml3-GLD` |
| Tiers | `predixa-tiers-GLD` |

Handlers: `tradespark/ticker-handlers/GLD/ml/model_3mix/{features,model1,model2,model3,tiers}/`.
...
aws stepfunctions create-state-machine \
  --name Predixa-GLD-ML-Then-Tiers \
  --definition file://infrastructure/step-functions/gld-ml-then-tiers.asl.json \
