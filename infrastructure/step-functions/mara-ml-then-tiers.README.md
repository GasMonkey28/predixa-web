# Predixa-MARA-ML-Then-Tiers

Per-ticker equity pipeline (MARA pilot). Tiers write ratings + detail description
into `db/tickers/MARA/features.db`.
...
| State | Function |
|-------|----------|
| Features | `predixa-features-MARA` |
| ML1 | `predixa-ml1-MARA` |
| ML2 | `predixa-ml2-MARA` |
| ML3 | `predixa-ml3-MARA` |
| Tiers | `predixa-tiers-MARA` |

Handlers: `tradespark/ticker-handlers/MARA/ml/model_3mix/{features,model1,model2,model3,tiers}/`.
...
aws stepfunctions create-state-machine \
  --name Predixa-MARA-ML-Then-Tiers \
  --definition file://infrastructure/step-functions/mara-ml-then-tiers.asl.json \
