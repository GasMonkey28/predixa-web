# Predixa-TSLA-ML-Then-Tiers

Per-ticker equity pipeline (TSLA pilot). Tiers write ratings + detail description
into `db/tickers/TSLA/features.db`.
...
| State | Function |
|-------|----------|
| Features | `predixa-features-TSLA` |
| ML1 | `predixa-ml1-TSLA` |
| ML2 | `predixa-ml2-TSLA` |
| ML3 | `predixa-ml3-TSLA` |
| Tiers | `predixa-tiers-TSLA` |

Handlers: `tradespark/ticker-handlers/TSLA/ml/model_3mix/{features,model1,model2,model3,tiers}/`.
...
aws stepfunctions create-state-machine \
  --name Predixa-TSLA-ML-Then-Tiers \
  --definition file://infrastructure/step-functions/tsla-ml-then-tiers.asl.json \
