# Predixa-META-ML-Then-Tiers

Per-ticker equity pipeline (META pilot). Tiers write ratings + detail description
into `db/tickers/META/features.db`.
...
| State | Function |
|-------|----------|
| Features | `predixa-features-META` |
| ML1 | `predixa-ml1-META` |
| ML2 | `predixa-ml2-META` |
| ML3 | `predixa-ml3-META` |
| Tiers | `predixa-tiers-META` |

Handlers: `tradespark/ticker-handlers/META/ml/model_3mix/{features,model1,model2,model3,tiers}/`.
...
aws stepfunctions create-state-machine \
  --name Predixa-META-ML-Then-Tiers \
  --definition file://infrastructure/step-functions/meta-ml-then-tiers.asl.json \
