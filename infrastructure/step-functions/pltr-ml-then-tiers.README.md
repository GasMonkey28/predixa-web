# Predixa-PLTR-ML-Then-Tiers

Per-ticker equity pipeline (PLTR pilot). Tiers write ratings + detail description
into `db/tickers/PLTR/features.db`.
...
| State | Function |
|-------|----------|
| Features | `predixa-features-PLTR` |
| ML1 | `predixa-ml1-PLTR` |
| ML2 | `predixa-ml2-PLTR` |
| ML3 | `predixa-ml3-PLTR` |
| Tiers | `predixa-tiers-PLTR` |

Handlers: `tradespark/ticker-handlers/PLTR/ml/model_3mix/{features,model1,model2,model3,tiers}/`.
...
aws stepfunctions create-state-machine \
  --name Predixa-PLTR-ML-Then-Tiers \
  --definition file://infrastructure/step-functions/pltr-ml-then-tiers.asl.json \
