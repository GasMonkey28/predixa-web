# Predixa-WULF-ML-Then-Tiers

Per-ticker equity pipeline (WULF pilot). Tiers write ratings + detail description
into `db/tickers/WULF/features.db`.
...
| State | Function |
|-------|----------|
| Features | `predixa-features-WULF` |
| ML1 | `predixa-ml1-WULF` |
| ML2 | `predixa-ml2-WULF` |
| ML3 | `predixa-ml3-WULF` |
| Tiers | `predixa-tiers-WULF` |

Handlers: `tradespark/ticker-handlers/WULF/ml/model_3mix/{features,model1,model2,model3,tiers}/`.
...
aws stepfunctions create-state-machine \
  --name Predixa-WULF-ML-Then-Tiers \
  --definition file://infrastructure/step-functions/wulf-ml-then-tiers.asl.json \
