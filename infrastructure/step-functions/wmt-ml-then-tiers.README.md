# Predixa-WMT-ML-Then-Tiers

Per-ticker equity pipeline (WMT pilot). Tiers write ratings + detail description
into `db/tickers/WMT/features.db`.
...
| State | Function |
|-------|----------|
| Features | `predixa-features-WMT` |
| ML1 | `predixa-ml1-WMT` |
| ML2 | `predixa-ml2-WMT` |
| ML3 | `predixa-ml3-WMT` |
| Tiers | `predixa-tiers-WMT` |

Handlers: `tradespark/ticker-handlers/WMT/ml/model_3mix/{features,model1,model2,model3,tiers}/`.
...
aws stepfunctions create-state-machine \
  --name Predixa-WMT-ML-Then-Tiers \
  --definition file://infrastructure/step-functions/wmt-ml-then-tiers.asl.json \
