# Predixa-AMZN-ML-Then-Tiers

Per-ticker equity pipeline (AMZN pilot). Tiers write ratings + detail description
into `db/tickers/AMZN/features.db`.
...
| State | Function |
|-------|----------|
| Features | `predixa-features-AMZN` |
| ML1 | `predixa-ml1-AMZN` |
| ML2 | `predixa-ml2-AMZN` |
| ML3 | `predixa-ml3-AMZN` |
| Tiers | `predixa-tiers-AMZN` |

Handlers: `tradespark/ticker-handlers/AMZN/ml/model_3mix/{features,model1,model2,model3,tiers}/`.
...
aws stepfunctions create-state-machine \
  --name Predixa-AMZN-ML-Then-Tiers \
  --definition file://infrastructure/step-functions/amzn-ml-then-tiers.asl.json \
